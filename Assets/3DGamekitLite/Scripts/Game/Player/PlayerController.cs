...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        // CODE ADDED BY DELAINA HARDWICK ------------------------------------//
        //--------------------------------------------------------------------//
        ...
        public void OnTriggerEnter(Collider collider)
        {
            ...
            {
                GameObject.Find("Ellen").GetComponentInChildren<Damageable>().ResetDamage();
                Debug.Log("Did I get my health back yet?");
            }
        }
        ...
        public void OnTriggerStay(Collider collider)
        {
            if (collider.gameObject.tag == "Platform")
            {
                ...
                Debug.Log("Ellen's parent is now " + transform.parent);
            }
        }
        ...
        public void OnTriggerExit(Collider collider)
        {
            if (collider.gameObject.tag == "Platform")
            {
                ...
                Debug.Log("OnTriggerExit has been called");
            }
        }
    }
}